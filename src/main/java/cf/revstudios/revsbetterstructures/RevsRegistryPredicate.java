...
public class RevsRegistryPredicate extends RegistryPredicateArgumentType<ConfiguredStructureFeature<?, ?>> {
    ...
    @Override
    public RegistryPredicate<ConfiguredStructureFeature<?, ?>> parse(StringReader stringReader) throws CommandSyntaxException {
        Identifier identifier = Identifier.fromCommandInput(stringReader);
        identifier = new Identifier(RevsBetterStructures.MODID, identifier.getPath());
        return new RegistryKeyBased<>(RegistryKey.of(Registry.CONFIGURED_STRUCTURE_FEATURE_KEY, identifier));
    }
