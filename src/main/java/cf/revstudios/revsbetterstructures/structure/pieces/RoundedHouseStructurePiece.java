...
public class RoundedHouseStructurePiece extends BasicStructurePiece {
    public RoundedHouseStructurePiece(StructureManager structureManager, NbtCompound nbtCompound) {
