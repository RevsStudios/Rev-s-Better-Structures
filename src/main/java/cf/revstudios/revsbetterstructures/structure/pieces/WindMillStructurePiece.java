...
public class WindMillStructurePiece extends BasicStructurePiece {
    public WindMillStructurePiece(StructureManager structureManager, NbtCompound nbtCompound) {
