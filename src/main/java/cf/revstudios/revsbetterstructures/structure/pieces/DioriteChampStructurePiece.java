...
public class DioriteChampStructurePiece extends BasicStructurePiece {
    public DioriteChampStructurePiece(StructureManager structureManager, NbtCompound nbtCompound) {
