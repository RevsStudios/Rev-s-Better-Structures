...
public class NetherTowerStructurePiece extends BasicStructurePiece {
    public NetherTowerStructurePiece(StructureManager structureManager, NbtCompound nbtCompound) {
