...
public class SpruceTowerStructurePiece extends BasicStructurePiece {
    public SpruceTowerStructurePiece(StructureManager structureManager, NbtCompound nbtCompound) {
