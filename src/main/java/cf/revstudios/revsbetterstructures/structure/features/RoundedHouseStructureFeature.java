...
public class RoundedHouseStructureFeature extends StructureFeature<DefaultFeatureConfig> {
    public RoundedHouseStructureFeature(Codec<DefaultFeatureConfig> codec) {
        super(codec);
    }
