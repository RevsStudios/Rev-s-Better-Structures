...
public class SpruceTowerStructureFeature extends StructureFeature<DefaultFeatureConfig> {
    public SpruceTowerStructureFeature(Codec<DefaultFeatureConfig> codec) {
        super(codec);
    }
