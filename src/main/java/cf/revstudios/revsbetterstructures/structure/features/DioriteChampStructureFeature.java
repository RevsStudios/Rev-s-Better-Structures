...
public class DioriteChampStructureFeature extends StructureFeature<DefaultFeatureConfig> {
    public DioriteChampStructureFeature(Codec<DefaultFeatureConfig> codec) {
        super(codec);
    }
