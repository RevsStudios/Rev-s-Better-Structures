...
public class BrownTeepeeStructureFeature extends StructureFeature<DefaultFeatureConfig> {
    public BrownTeepeeStructureFeature(Codec<DefaultFeatureConfig> codec) {
        super(codec);
    }
