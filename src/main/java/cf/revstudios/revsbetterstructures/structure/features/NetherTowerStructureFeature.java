...
public class NetherTowerStructureFeature extends StructureFeature<DefaultFeatureConfig> {
    public NetherTowerStructureFeature(Codec<DefaultFeatureConfig> codec) {
        super(codec);
    }
