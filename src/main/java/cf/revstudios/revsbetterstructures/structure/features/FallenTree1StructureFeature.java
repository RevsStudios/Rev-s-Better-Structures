...
public class FallenTree1StructureFeature extends StructureFeature<DefaultFeatureConfig> {
    public FallenTree1StructureFeature(Codec<DefaultFeatureConfig> codec) {
        super(codec);
    }
