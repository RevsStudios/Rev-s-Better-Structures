...
public class SmallHouseStructureFeature extends StructureFeature<DefaultFeatureConfig> {
    public SmallHouseStructureFeature(Codec<DefaultFeatureConfig> codec) {
        super(codec);
    }
