...
public class RevsConfiguredStructures {
	...
	public static StructureFeature<?, ?> CONFIGURED_BLUETEEPEE = RevsStructures.BLUETEEPEE.get().configured(IFeatureConfig.NONE);
	public static StructureFeature<?, ?> CONFIGURED_BROWNTEEPEE = RevsStructures.BROWNTEEPEE.get().configured(IFeatureConfig.NONE);
	public static StructureFeature<?, ?> CONFIGURED_YELLOWTEEPEE = RevsStructures.YELLOWTEEPEE.get().configured(IFeatureConfig.NONE);
	...
	public static void registerConfiguredStructures() {
		...
		Registry.register(registry, new ResourceLocation(RevsBetterStructures.MODID, "configured_blueteepee"), CONFIGURED_BLUETEEPEE);
		Registry.register(registry, new ResourceLocation(RevsBetterStructures.MODID, "configured_brownteepee"), CONFIGURED_BROWNTEEPEE);
		Registry.register(registry, new ResourceLocation(RevsBetterStructures.MODID, "configured_yellowteepee"), CONFIGURED_YELLOWTEEPEE);
		...
		FlatGenerationSettings.STRUCTURE_FEATURES.put(RevsStructures.BLUETEEPEE.get(), CONFIGURED_BLUETEEPEE);
		FlatGenerationSettings.STRUCTURE_FEATURES.put(RevsStructures.BROWNTEEPEE.get(), CONFIGURED_BROWNTEEPEE);
		FlatGenerationSettings.STRUCTURE_FEATURES.put(RevsStructures.YELLOWTEEPEE.get(), CONFIGURED_YELLOWTEEPEE);
		...
		FlatGenerationSettings.STRUCTURE_FEATURES.put(RevsStructures.ROCKCHAMP.get(), CONFIGURED_ROCKCHAMP);
		FlatGenerationSettings.STRUCTURE_FEATURES.put(RevsStructures.ROCKCHAMP2.get(), CONFIGURED_ROCKCHAMP2);
	}
}