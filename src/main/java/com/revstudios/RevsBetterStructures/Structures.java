...
import com.revstudios.RevsBetterStructures.structures.Windmil;
...
public class Structures {
     ...
     */
    public static final DeferredRegister<Structure<?>> DEFERRED_REGISTRY_STRUCTURE = DeferredRegister.create(ForgeRegistries.STRUCTURE_FEATURES, RevsBetterStructures.MODID);

    /**
     * Registers the structure itself and sets what its path is. In this case, the
     * structure will have the resourcelocation of structure_tutorial:Windmil.
     *
     ...
     */
    public static final RegistryObject<Structure<NoFeatureConfig>> Windmil = DEFERRED_REGISTRY_STRUCTURE.register("Windmil", (Supplier<? extends I>) () -> (new Windmil(NoFeatureConfig.CODEC)));
    ...
    public static void setupStructures() {
        setupMapSpacingAndLand(
                Windmil.get(), /* The instance of the structure */
            ...
            boolean transformSurroundingLand)
    {
         ...
         *
         * Instead, we will use the WorldEvent.Load event in RevsBetterStructures to add the structure
